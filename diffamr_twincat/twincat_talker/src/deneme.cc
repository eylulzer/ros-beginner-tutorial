...
//Yazdırma işlemi yapılırken hexadecimale çevirilmiştir. 
...
{
    AdsVariable<uint8_t> simpleVar {route, "MAIN.byByte[1]"};
    AdsVariable<uint8_t> validation {route, "MAIN.byByte[2]"};
